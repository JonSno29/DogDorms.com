...
$(function () {
  ...
  $("#contactForm").validate({
    ...
    submitHandler: function (element) {
      ...
      $(ajaxform)
        .find('[name="submit"]')
        .html('<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> Sending...');
      ...
      $.ajax({
        ...
        success: function (response) {
          if (response.type == "success") {
            $("#contactForm").before(
              "<div class='alert alert-success' role='alert'><a href='#' class='close' data-dismiss='alert'>&times;</a>" +
                response.text +
                "</div>"
            );
            $(ajaxform)
              .each(function () {
                ...
                $(this)
                  .find('[name="submit"]')
                  .html('<i class="fa fa-paper-plane fa-fw"></i> Send');
              })
              .find(".valid")
              .each(function () {
